        ...
        <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 search">
            <div class="contact-row">
                <div class="phone inline">
                    <i class="icon fa fa-phone"></i> 0939771987

                </div>
                <div class="contact inline">
                    <i class="icon fa fa-envelope"></i> huyminhcantho@gmail.com
...
<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 hidden-xs" style="margin-top: 24px;">
    <!-- Cart -->
